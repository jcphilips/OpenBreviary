...
## TODO
- [x] Implement Psalter Week Calculator.
- [x] Get Start of Advent of previous year to have a proper understanding of the season.
- [ ] Season calculator logic to be reviewed for ranking.
- [ ] Create Psalter with readings.
- [ ] Handle intercessions.
